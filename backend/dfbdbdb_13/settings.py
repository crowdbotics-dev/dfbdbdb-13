"""
Django settings for dfbdbdb_13 project.
...
WSGI_APPLICATION = 'dfbdbdb_13.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dfbdbdb_13 API",
    "DESCRIPTION": "API documentation for dfbdbdb_13 App",
    "VERSION": "v1",
}
